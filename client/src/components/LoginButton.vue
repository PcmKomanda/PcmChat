  ...
  methods: {
    login(provider) {
      ...
      this.popup = window.open(
        ...
        "_blank",
        'width=600,height=600, "location=no"'
      );
    ...
    >
      <div class="">
        <svg
          v-if="loading"
          aria-hidden="true"
          class="w-[30px] h-[30px] m-2 mx-auto text-gray-200 animate-spin dark:text-gray-700 fill-white"
          viewBox="0 0 100 101"
          fill="none"
      ...
      <div v-if="!loading">
        <i
          class="fa-brands animate-wiggle place-self-center pr-2"
          :class="`fa-${provider}`"
        ></i>
